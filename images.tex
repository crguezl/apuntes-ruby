...
\title{Apuntes de RUBY}
\author{Casiano R. León \thanks{DEIOC Universidad de La Laguna} \date{}}
\date{\normalsize\today}
...
\htmladdtonavigation{\htmladdnormallink{
     ...
     {logoLPP.png}}
     {http://nereida.deioc.ull.es/~lpp/index.html}} 
...
\htmladdtonavigation{\htmladdnormallink{
     ...
     {moodleLHPlogo.jpeg}}
     {http://campusvirtual.ull.es/1314/course/view.php?id=1102}} 
...
\htmladdtonavigation{\htmladdnormallink{
     ...
     {lupa.gif}}
     {https://dl.dropbox.com/u/14539152/LPP/LPPbook/index.html}} 
...
\htmladdtonavigation{\htmladdnormallink{
     ...
     {etsii.png}}
     {http://www.ull.es/view/centros/etsii/Inicio/es}} 
...
\htmladdtonavigation{\htmladdnormallink{
     \htmladdimg[
                 width=32 
                 alt="ull-etsii-grado-lpp-1314"
                ]
     {logopcgull.gif}}
     {https://plus.google.com/u/0/communities/115470806071217401678}} 


\htmladdtonavigation{\htmladdnormallink{
     \htmladdimg[
                 width=32 
                 alt="ull-etsii-grado-stw-1314"
                ]
     {logopcgull.gif}}
     {https://plus.google.com/u/0/communities/109091480492072495700}} 
...
{\newpage\clearpage
\lthtmlinlineA{tex2html_nomath_inline46581}%
\textquestiondown%
\lthtmlinlineZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline46586}%
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline47517}%
$ (x_1,y_1) + (x_2, y_2) = (x_1 + y_1, x_2+y_2)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline47519}%
$ (x,y) * \lambda = (\lambda * x, \lambda * y)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline47521}%
$ -(x, y) = (-x, -y)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
